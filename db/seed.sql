...
VALUES
    ...
    ('How have Ukrainian authorities responded to the humanitarian crisis in Avdiivka?', 'Setting up heated shelters and preparing for evacuation', 'Closing all borders and declaring martial law', 'Requesting direct military intervention from NATO', 'Surrendering the town to separatist forces', 123456789),
    ('What concern do Ukrainian officials have about US-Russia relations?', 'Western pressure on Russia to withdraw from eastern Ukraine might ease', 'The US might join Russia in supporting the separatists', 'Russia might increase its military presence in Ukraine', 'The US might stop all diplomatic relations with Ukraine', 123456789);
